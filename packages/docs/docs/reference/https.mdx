...
This will set up a domain name server -- the *end part*, which is the name you purchased.
...
Shipula will then verify the domain is resolving properly and issue a *certificate* to use [HTTPS], and validate this.
